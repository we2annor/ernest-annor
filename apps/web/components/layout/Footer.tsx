...
const socialLinks = [
  {
    label: "GitHub",
    href: "https://github.com/we2annor",
    icon: (
      <svg
        width='20'
        height='20'
      ...
      <div className='max-w-6xl mx-auto px-6 py-12'>
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mb-12'>
          ...
          <div className='space-y-4'>
            ...
            <p className='text-text-muted text-sm leading-relaxed max-w-xs'>
              ...
              applications at scale. Based in London, UK.
            </p>
          </div>

          {/* Quick links */}
          <div className='space-y-4'>
            <h3 className='font-syne font-semibold text-text-primary text-sm uppercase tracking-widest'>
              Navigation
            </h3>
        ...
        <div className='border-t border-border pt-8 flex flex-col md:flex-row items-center justify-between gap-4'>
          <p className='text-text-muted text-sm'>
            © {currentYear} Ernest Annor. All rights reserved.
          </p>
          <p className='text-text-muted text-sm'>
