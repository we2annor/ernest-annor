...
const sizeStyles: Record<ButtonSize, string> = {
  sm: "px-5 py-2 text-sm min-h-[36px] min-w-[80px]",
  md: "px-7 py-3 text-base min-h-[44px] min-w-[120px]",
  lg: "px-9 py-4 text-lg min-h-[52px] min-w-[160px]",
};

const baseStyles =
  "inline-flex items-center justify-center gap-2 rounded-lg transition-all duration-200 cursor-pointer focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 focus:ring-offset-background isabled:opacity-50 disabled:cursor-not-allowed";
